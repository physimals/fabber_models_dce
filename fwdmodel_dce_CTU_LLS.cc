/*  fwdmodel_DCE_CTU_LLS.cc - Implements a convolution based model for DCE analysis
...
FactoryRegistration<FwdModelFactory, DCE_CTU_LLS_FwdModel>
  DCE_CTU_LLS_FwdModel::registration("dce_CTU_LLS");
...
void DCE_CTU_LLS_FwdModel::HardcodedInitialDists(MVNDist& prior,
    MVNDist& posterior) const
{
    Tracer_Plus tr("DCE_CTU_LLS_FwdModel::HardcodedInitialDists");
...
void DCE_CTU_LLS_FwdModel::Evaluate(const ColumnVector& params, ColumnVector& result) const
{
  Tracer_Plus tr("DCE_CTU_LLS_FwdModel::Evaluate");
...
FwdModel* DCE_CTU_LLS_FwdModel::NewInstance()
{
  return new DCE_CTU_LLS_FwdModel();
}

void DCE_CTU_LLS_FwdModel::Initialize(ArgsType& args)
{
  Tracer_Plus tr("DCE_CTU_LLS_FwdModel::DCE_CTU_LLS_FwdModel");
...
vector<string> DCE_CTU_LLS_FwdModel::GetUsage() const
{
  vector<string> usage;
  ...
  usage.push_back( " PS: the Permebility Surface Area Product\n");

  return usage;
}

void DCE_CTU_LLS_FwdModel::DumpParameters(const ColumnVector& vec,
                                    const string& indent) const
{
    
}

void DCE_CTU_LLS_FwdModel::NameParams(vector<string>& names) const
{
  names.clear();
...
ColumnVector DCE_CTU_LLS_FwdModel::aifshift( const ColumnVector& aif, const float delta, const float hdelt ) const
{
...
void DCE_CTU_LLS_FwdModel::createconvmtx( LowerTriangularMatrix& A, const ColumnVector aifnew ) const
{
