...
FactoryRegistration<FwdModelFactory, DCEFwdModel> 
  DCEFwdModel::registration("dce");
...
FwdModel* DCEFwdModel::NewInstance()
{
  return new DCEFwdModel();
}

void DCEFwdModel::Initialize(ArgsType& args)
{
  Tracer_Plus tr("DCEFwdModel::DCEFwdModel");
...
vector<string> DCEFwdModel::GetUsage() const
{
  vector<string> usage;
