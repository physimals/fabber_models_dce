/*  fwdmodel_dce_2CXM.h - Implementation of the non-linear least square solution of the two compartment exchange model
 ...
 */
class DCE_2CXM_FwdModel : public FwdModel
{
public:
...
private:
    ...
    double initial_Fp, initial_PS, initial_Vp, initial_Ve;
