...
FactoryRegistration<FwdModelFactory, DCE_LLS_FwdModel>
  DCE_LLS_FwdModel::registration("dce_LLS");

string DCE_LLS_FwdModel::ModelVersion() const
{
  return "$Id: fwdmodel_dce_LLS_.cc,v 1.11 2016/01/06 15:20:47 Kallehauge Exp $";
}

void DCE_LLS_FwdModel::HardcodedInitialDists(MVNDist& prior,
    MVNDist& posterior) const
{
    Tracer_Plus tr("DCE_LLS_FwdModel::HardcodedInitialDists");
...
{
  Tracer_Plus tr("DCE_LLS_FwdModel::Evaluate");
...
void DCE_LLS_FwdModel::Initialize(ArgsType& args)
{
  Tracer_Plus tr("DCE_LLS_FwdModel::DCE_LLS_FwdModel");
...
void DCE_LLS_FwdModel::DumpParameters(const ColumnVector& vec,
...
ColumnVector DCE_LLS_FwdModel::aifshift( const ColumnVector& aif, const float delta, const float hdelt ) const
{
...
void DCE_LLS_FwdModel::createconvmtx( LowerTriangularMatrix& A, const ColumnVector aifnew ) const
{
